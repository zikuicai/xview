...
parser.add_argument("--output_dir", type=str, default="/media/rongjia/Data/xview_data/dayton_fork_train", help="where to put output files")
...
Model = collections.namedtuple("Model", "outputs, predict_real, predict_fake, discrim_loss, discrim_grads_and_vars, gen_loss_GAN, gen_loss_L1, gen_loss_L1_seg, gen_grads_and_vars, train")
...
def load_examples():
    ...
    return Examples(
        ...
        inputs_seg=inputs_batch_seg,
        targets_seg=targets_batch_seg,
        count=len(input_paths),
        steps_per_epoch=steps_per_epoch,
    )


# U-Net Generator X-Fork
def create_generator(generator_inputs, generator_outputs_channels):
    layers = []
    generator_outputs_channels_seg = generator_outputs_channels
    ...
    with tf.variable_scope("decoder_1"):
        ...
        output_seg = gen_deconv(rectified, generator_outputs_channels_seg)
        output_seg = tf.tanh(output_seg)
        layers.append([output,output_seg])
...
def create_model(inputs, targets, targets_seg):
    ...
    with tf.variable_scope("generator"):
        ...
        outputs_all = create_generator(inputs, out_channels)
        outputs = outputs_all[0]
        outputs_seg = outputs_all[1]
    ...
    with tf.name_scope("generator_loss"):
        ...
        gen_loss_L1_seg = tf.reduce_mean(tf.abs(targets_seg - outputs_seg))
        gen_loss = gen_loss_GAN * a.gan_weight + gen_loss_L1 * a.l1_weight + gen_loss_L1_seg * a.l1_weight
    ...
    update_losses = ema.apply([discrim_loss, gen_loss_GAN, gen_loss_L1, gen_loss_L1_seg])
    ...
    return Model(
        ...
        gen_loss_L1_seg=ema.average(gen_loss_L1_seg),
...
def main():
    ...
    model = create_model(examples.inputs, examples.targets, examples.targets_seg)
    ...
    tf.summary.scalar("generator_loss_L1_seg", model.gen_loss_L1_seg)
        ...
        if a.mode == "test":
            ...
            for step in range(max_steps):
                ...
                if should(a.progress_freq):
                    ...
                    fetches["gen_loss_L1_seg"] = model.gen_loss_L1_seg
                ...
                if should(a.progress_freq):
                    ...
                    print("gen_loss_L1_seg", results["gen_loss_L1_seg"])
